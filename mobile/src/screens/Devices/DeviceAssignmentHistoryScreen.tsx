...
const DeviceAssignmentHistoryScreen = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            ...
            <View className="flex-row items-center justify-center gap-3 bg-white px-5">
                {/* Nút Cấp phát */}
                <TouchableOpacity
                    onPress={() => setAssignModalVisible(true)}
                    className="w-12 h-12 rounded-full bg-green-500 items-center justify-center mb-4"
                >
                ...
                {canRevokeDevice() && (
                    <TouchableOpacity
                        ...
                        className="w-12 h-12 rounded-full bg-[#EAA300] items-center justify-center mb-4"
                    >
                ...
                <TouchableOpacity
                    ...
                    className="w-12 h-12 rounded-full bg-red-500 items-center justify-center mb-4"
                >
