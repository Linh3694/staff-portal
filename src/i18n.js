...
const resources = {
  en: {
    translation: {
      ...
      term:"I commit to uploading only positive content images and not violating ethical or cultural norms.",
      post:"Post",
      cancel:"Cancel",
      ...
      welcome_banner_01: "The vibrant atmosphere of Tet, filled with the colors of spring, has spread throughout Wellspring Hanoi! This is the perfect time for every WISer to pause, reflect on the past year, refresh themselves, share love, and create meaningful Tet memories.",
      welcome_banner_02: "Are the WISers ready for the 6 Tet Challenges? A place to capture every brilliant moment, embracing the true spirit of the 2025 Spring Festival – Home is where Tet lives in our hearts!",
      welcome_banner_03: "Get your best shots ready and let’s welcome an unforgettable Tet season together!",
      ...
      ending:"We will reunite after the Tet holiday, continuing to conquer new challenges on our academic journey. We hope that students, teachers, and staff will return to school with enthusiasm, ready for productive days of learning and working. Wishing all WISers a peaceful, joyful, and meaningful Tet season with family and friends!",
    },
  },
  vi: {
    translation: {
      ...
      picture:"Thêm ảnh",
      term:"Tôi cam kết đăng những hình ảnh mang nội dung tích cực, không vi phạm thuần phong mỹ tục.Tôi cam kết đăng những hình ảnh mang nội dung tích cực, không vi phạm thuần phong mỹ tục.",
      post:"Đăng bài",
      cancel:"Huỷ",
