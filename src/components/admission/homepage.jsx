    ...
    <div className="container mx-auto p-4 max-w-4xl">
      <div className="bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="bg-[#002147] text-white p-4">
          <h1 className="text-2xl font-bold text-center">Quản Lý Thống Kê Tuyển Sinh</h1>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              <h3 className="text-lg font-semibold text-gray-500">Học sinh mới</h3>
              <p className="text-3xl font-bold text-[#002147]">{admissionStats.newStudents}</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg text-center">
              <h3 className="text-lg font-semibold text-gray-500">Học sinh tái ghi danh</h3>
              <p className="text-3xl font-bold text-[#002147]">{admissionStats.returningStudents}</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg text-center">
              <h3 className="text-lg font-semibold text-gray-500">Tổng số học sinh</h3>
              <p className="text-3xl font-bold text-[#002147]">{admissionStats.totalStudents}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border p-4 rounded-lg">
              <h3 className="text-xl font-semibold mb-4 text-[#002147]">Học sinh mới</h3>
              <form onSubmit={updateNewStudents} className="mb-4">
                <div className="flex items-center mb-4">
                  <input
                    type="number"
                    className="border rounded-l px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-[#002147]"
                  ...
                  <button 
                    type="submit"
                    className="bg-[#002147] text-white px-4 py-2 rounded-r hover:bg-[#001b38] transition-colors"
                  >
                    Cập nhật
                  </button>
                </div>
            ...
            <div className="border p-4 rounded-lg">
              <h3 className="text-xl font-semibold mb-4 text-[#002147]">Học sinh tái ghi danh</h3>
              <form onSubmit={updateReturningStudents} className="mb-4">
                <div className="flex items-center mb-4">
                  <input
                    ...
                    onChange={(e) => setReturningStudentsInput(e.target.value)}
                    min="0"
                  />
                  <button 
                    type="submit"
