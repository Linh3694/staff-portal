...
function FlippageAdmin({ currentUser }) {
  ...
  const handleUpdateFile = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/flippage/update-pdf/${editingFile._id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          <table className="w-full">
            <thead>
              <tr className="!border-px !border-gray-400">
                ...
                <th className="cursor-pointer border-b-[1px] border-gray-200 pt-4 pb-2 pr-4 text-start">
                  <p className="text-sm font-bold text-gray-500">Tên File</p>
                </th>
                <th className="cursor-pointer border-b-[1px] border-gray-200 pt-4 pb-2 pr-4 text-start">
              ...
              {filteredFiles.map((file, index) => (
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="border-white/0 py-3 pr-4">
                    <Switch
                      onChange={() =>
                        toggleActiveStatus(file._id, !file.active)
                      }
                      checked={file.active}
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      <table className="w-full border-collapse">
                        <thead className="bg-[#EEF1F5] border-b">
                          <tr>
                            <th className="py-2 px-4 text-left text-sm font-semibold text-[#002147]">
                              Tiêu đề
                            </th>
                            <th className="py-2 px-4 text-left text-sm font-semibold text-[#002147]">
                              Số trang
                  ...
                  <div className="w-1/2 flex flex-col space-y-4 border-r-2 border-gray-100 pr-4">
                    ...
                    <div className="border-b-2 border-gray-100 pb-3 mt-2">
                      ...
                      <p className="mt-2 text-sm font-semibold text-gray-600">
                        ...
                        <span className="text-[#002147] font-bold">
                          https://360wiser.wellspring.edu.vn/
                          {customName || "duong-dan-file"}
                        </span>
                      </p>
                      <p
                        className={`mt-2 mb-2 text-sm font-semibold ${
                          isCustomNameValid === false
                            ? "text-red-600"
                            : isCustomNameValid === true
                            ? "text-green-600"
                            : "text-gray-600"
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm mb-3">
                        Tạo mục lục để người đọc có thể dễ dàng tìm kiếm thông
                        tin trong tài liệu
                      </p>
                      ...
                      {selectedFile && (
                        <div className="flex items-center justify-between mt-3 p-3 bg-[#E4E9EF] rounded-lg">
                          <div className="w-full flex flex-row justify-between items-center">
                            <a
                              href="#"
                              className="text-[#002147] font-medium truncate max-w-[200px]"
                            >
                              {selectedFile.name}
                            </a>
          ...
          ReactDOM.createPortal(
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
                ...
                <p>
                  Bạn có chắc chắn muốn **xoá vĩnh viễn** tài liệu{" "}
                  <strong>{deletingFile.fileName}</strong>?<br />
                ...
                <div className="flex justify-end mt-4 space-x-2">
                  ...
                  <button
                    onClick={() => confirmPermanentDelete(deletingFile._id)}
