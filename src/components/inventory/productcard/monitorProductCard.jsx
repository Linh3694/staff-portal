...
const MonitorProductCard = ({
  ...
  useEffect(() => {
    if (localMonitor?.room) {
      const detailedRoom = rooms.find((room) => room.value === localMonitor.room._id);
          ...
          <div className="flex items-center justify-between bg-gray-100 p-3 rounded-xl mb-4 mt-0 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex items-center space-x-2">
              {editField === "display" ? (
                ...
                <button onClick={() => handleEditSpec("display", monitorData.specs?.display)}>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                {editField === "releaseYear" ? (
                  ...
                  <p className="font-semibold">{monitorData.releaseYear || "N/A"}</p>
                )}
              </div>
            </div>
            <div className="flex items-center space-x-2">
              {editField === "releaseYear" ? (
                ...
                <button onClick={() => handleEditSpec("releaseYear", monitorData.releaseYear)}>
                  <FiEdit className="text-[#FF5733] hover:scale-110" size={15} />
                </button>
              )}
            </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              {editField === "manufacturer" ? (
                ...
                <p className="font-semibold">{monitorData.manufacturer || "N/A"}</p>
              )}
            </div>
          </div>
          <div className="flex items-center space-x-2">
            {editField === "manufacturer" ? (
              ...
              <button onClick={() => handleEditSpec("manufacturer", monitorData.manufacturer)}>
                <FiEdit className="text-[#FF5733] hover:scale-110" size={15} />
              </button>
            )}
          </div>
