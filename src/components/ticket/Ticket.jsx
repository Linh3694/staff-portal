  ...
  const fetchUserTickets = async () => {
    try {
      ...
      if (currentUser?.id) {
        ...
        console.warn(
          "⚠️ Không tìm thấy currentUser, gửi request không có creator"
        );
      }
              ...
              <div className="w-full rounded-lg p-4 flex flex-col gap-2 border">
                ...
                <div className="w-full grid grid-cols-3 gap-2 ">
                  ...
                  <button
                    className={`px-3 py-1 rounded-full transition ${
                      filterStatus === "Open"
                        ? "bg-blue-200 text-[#002147] font-semibold"
                        : "bg-gray-100 text-gray-600"
                    }`}
                  ...
                  <button
                    className={`px-3 py-1 rounded-full transition ${
                      filterStatus === "Waiting for Customer"
                        ? "bg-blue-200 text-blue-800 font-semibold"
                        : "bg-gray-100 text-gray-600"
                    }`}
            ...
            {userTickets.length === 0 ? (
              ...
              userTickets.map((ticket) => (
                ...
                >
                  ...
                  {/* Trạng thái ticket */}
                  <span
                    className={`px-3 py-1 text-sm rounded-lg font-semibold mt-6 ${
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16">
                      {[
                        ...
                        },
                        {
                          ...
                          description:
                            "“Hỗ trợ sự kiện” áp dụng cho các yêu cầu hỗ trợ kỹ thuật trong quá trình tổ chức sự kiện trong trường.",
                        },
                        {
                          type: "hrorder",
                          label: "Order Nhân sự",
                          ...
                          description:
                            "“Order nhân sự” áp dụng cho các yêu cầu bổ sung nhân sự trong các tình huống cụ thể.",
                        },
                    ...
                    {ticketData.type === "event" ? (
                      ...
                      <div className="w-full max-w-2xl">
                        <h1 className="text-center text-2xl font-bold text-[#002147] mb-8">
                          Bạn hãy nhập nội dung và mô tả chi tiết cho chúng tớ
                          nhé
                        </h1>
                ...
                {step === 5 && (
                  <div className="w-full flex flex-col items-center text-center pt-12">
                    ...
                    <p className="text-lg text-gray-600 mt-2">
                      Yêu cầu của bạn đã được ghi nhận. Nhân viên hỗ trợ sẽ liên
                      hệ lại với bạn sớm nhất có thể.
                    </p>
                    {ticketCreatedId && (
