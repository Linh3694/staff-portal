        ...
        <div className="grid grid-cols-[2fr,3fr] gap-4">
          ...
          <div className="flex flex-col w-auto space-y-4">
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
              <h3 className="text-sm font-semibold mb-3 text-[#002147]">
                Bên Giao
              </h3>
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-xs text-gray-300">
                      {currentUser.jobTitle || "Không xác định"}
                    </p>
                  </div>
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            <p className="font-semibold mb-3">Thông tin bàn giao</p>
            {/* Block 1: Thông tin máy */}
            <div className="bg-[#E4E9EF] p-4 rounded-lg shadow-md mb-4">
              <h2 className="text-sm font-bold text-[#002147] mb-2">
                Thông tin máy
              </h2>
            ...
            <div className="bg-[#E4E9EF] p-4 rounded-lg shadow-md mb-4">
              ...
              <table className="bg-white w-full text-xs rounded-lg shadow-md">
                <thead className="bg-[#002147] h-8 text-white rounded-t-lg">
                  <tr>
                    <th className=" text-center uppercase font-semibold rounded-tl-lg">
                      Tiêu đề
                    </th>
                    <th className=" text-center uppercase font-semibold">
                      Thời gian
                    </th>
                    <th className=" text-center uppercase font-semibold">
                      Kỹ thuật viên
                    </th>
                    <th className=" text-center uppercase font-semibold rounded-tr-lg">
                      Phân loại
                    </th>
                  </tr>
                </thead>
