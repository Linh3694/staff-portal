        ...
        const handleDeleteRepair = async (laptopId, repairId) => {
          ...
          try {
            ...
            const response = await axios.delete(
              `http://10.1.34.162:5001/api/laptops/${laptopId}/repairs/${repairId}`,
          ...
          const handleAddRepair = async (repairData) => {
              try {
                ...
                console.log("Gửi yêu cầu tới:", `http://10.1.34.162:5001/api/laptops/${selectedLaptop._id}/repairs`);
                ...
                const response = await fetch(`http://10.1.34.162:5001/api/laptops/${selectedLaptop._id}/repairs`, {
                  method: "POST",
                  headers: {
          ...
          <laptopProductCard
            ...
            onAddRepair={(repair) => {
                    ...
                    fetch(`http://10.1.34.162:5001/api/laptops/${selectedLaptop._id}/repairs`, {
                      method: "POST",
          ...
          const fetchLaptops = async () => {
            try {
              const token = localStorage.getItem("authToken");
              const response = await axios.get("http://10.1.34.162:5001/api/laptops", {
                headers: { Authorization: `Bearer ${token}` },
              });
          ...
          const handleDelete = async (id) => {
            if (!laptopToDelete) return;
              ...
              try {
                await axios.delete(`http://10.1.34.162:5001/api/laptops/${laptopToDelete._id}`, {
                  headers: {
          ...
          const handleAddLaptop = async (e) => {
            ...
            try {
              ...
              // Gửi dữ liệu lên API
              const response = await axios.post("http://10.1.34.162:5001/api/laptops", payload, {
                headers: {
        ...
        const handleConfirmUpload = async () => {
          ...
          try {
              ...
              const response = await axios.post(
                  "http://10.1.34.162:5001/api/laptops/bulk-upload",
                  { laptops: parsedData },
                  {
                      headers: {
                          "Content-Type": "application/json",
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    try {
                      ...
                      await axios.put(
                        `http://10.1.34.162:5001/api/laptops/${editingLaptop._id}`,
                        payload,
                        {
                          headers: {
                            Authorization: `Bearer ${localStorage.getItem("authToken")}`,
