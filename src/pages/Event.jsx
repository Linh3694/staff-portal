              ...
              {events.length === 0 ? (
                ...
                events.slice(0, 6).map((event) => (
                  ...
                  >
                    {/* Hiển thị hình ảnh */}
                    <img
                      src={`http://localhost:5001${event.image}`} // Đảm bảo đường dẫn ảnh đầy đủ
                      alt={event.name}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg w-full max-w-5xl p-6 flex">
              ...
              <div className="w-1/2 pr-4 border-r">
                ...
                {/* Ảnh sự kiện */}
                <img
                  src={`http://localhost:5001${selectedEvent.image}`}
...
{previewPhoto && (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white rounded-lg shadow-lg w-[80%] h-[80%] flex overflow-hidden">
      ...
      <img
        src={`http://localhost:5001${previewPhoto.url}`} // Sửa lại để tạo URL đầy đủ
