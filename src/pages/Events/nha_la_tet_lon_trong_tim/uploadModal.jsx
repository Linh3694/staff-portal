...
const UploadModal = ({ isOpen, onClose, eventId, user }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg p-6 w-[763px] shadow-lg">
        <div className="border-b">
          <h2 className="text-2xl text-center font-bold text-[#b42b23] mb-4 mt-2">Tham gia thử thách</h2>
        </div>
        <div className="grid grid-cols-2 justify-between">
        {/* Tiêu đề */}
        <div className="w-[400px] pr-4 mt-4 ml-2">
        {/* Nhập thông tin */}
        <div className="mb-4">
          <label className="block text-xl font-medium mb-2 text-[#5e191a]">Tiêu đề</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-xl font-medium mb-2 text-[#5e191a]">Nội dung</label>
          <textarea
        ...
        <div className="flex items-center mb-4">
          ...
          />
          <label htmlFor="agree" className="ml-2 text-base font-semibold text-[#5e191a]">
        ...
        <div className="flex justify-between">
          <button
            className="bg-[#b42b23] text-white px-4 py-2 rounded-md hover:bg-red-700 transition-all duration-300 w-1/2"
            onClick={handleSubmit}
          >
            Đăng bài
          </button>
          <button
            className="bg-[#fcf5e3] text-gray-800 px-4 py-2 rounded-md hover:bg-yellow-200 transition-all duration-300 w-1/2 ml-2"
