...
router.post("/:ticketId/messages", authenticate, uploadMessage.single("file"), ticketController.sendMessage);router.post("/:ticketId/subtasks", authenticate, ticketController.addSubTask);
